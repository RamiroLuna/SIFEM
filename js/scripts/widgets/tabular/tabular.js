...
//fin codigo programa 72 
               ...
               if (obj.options.userActive.program == '1') {
                     $("#tb_add_superficie_total").number( true, 3 );
                     //se solicita cambio de 2 a 3 decimales 7 de junio 2017 OCAMPO
                     $("#tb_add_superficie_anp_federal").number( true, 3 );
                     $("#tb_add_superficie_conservacion").number( true, 3 );
                     //se solicita cambio de 2 a 3 decimales 7 de junio 2017 OCAMPO
                     $("#tb_add_superficie_produccion").number( true, 3 );
                     $("#tb_add_superficie_restauracion").number( true, 3 );
                     $("#tb_add_superficie_otros_usos").number( true, 3 );
                     //se solicita cambio de 2 a 3 decimales 7 de junio 2017 OCAMPO
                     $("#tb_add_franja_protectora").number( true, 3 );

                     $("#tb_add_superficie_pendientes").number( true, 3 );
                     $("#tb_add_superficie_msnm").number( true, 3 );
                      //se solicita cambio de 2 a 3 decimales 7 de junio 2017 OCAMPO
                     $("#tb_add_superficie_bosque_mesofilo").number( true, 3 );
                     $("#tb_add_superficie_arbolada").number( true, 3 );

                     $("#tb_add_superficie_total").keyup(function(){
                         if($("#tb_add_superficie_otros_usos").val()==null || $("#tb_add_superficie_otros_usos").val()== '')
                             {
                                $("#tb_add_superficie_arbolada").val($("#tb_add_superficie_total").val());    
                             }
                             else
                             {
                              var  supTotal=parseFloat($("#tb_add_superficie_total").val())-parseFloat($("#tb_add_superficie_otros_usos").val());
                              $("#tb_add_superficie_arbolada").val(supTotal.toFixed(3));
                             }
                     });
                     $("#tb_add_superficie_otros_usos").keyup(function(){
                         if($("#tb_add_superficie_total").val()==null || $("#tb_add_superficie_total").val()== '')
                             {
                                $("#tb_add_superficie_otros_usos").val($("#tb_add_superficie_otros_usos").val());    
                             }
                             else
                             {
                              var  supTotal=parseFloat($("#tb_add_superficie_total").val())-parseFloat($("#tb_add_superficie_otros_usos").val());
